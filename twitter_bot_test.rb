...
# fetch the timeline for any Twitter user
# this method will return an array of Tweet objects you can interact with
tweets = client.user_timeline('rubyinside', count: 20)

# there is a full_text method that can print the tweet content
tweets.each { |tweet| puts tweet.full_text }

# save tweets into a file for later analysis. (YAML format)
File.write('tweets.yml', YAML.dump(tweets))

# load these tweets using the YAML.load_file method
